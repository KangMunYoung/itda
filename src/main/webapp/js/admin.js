   ...
   $.ajax({
    	...
    	success: function(result){
    		...
    		var tag="";
    			...
    			tag +=`<div> <label class="Modallabel"> 회원등급:</label> <select class="Modalselect" name="m_rank">  <option value="${result[0].m_rank}" selected>${result[0].m_name}</option> <option value="2">브론즈</option>  <option value="3">실버</option> <option value="4">골드</option> <option value="관리자">관리자</option> </select> </div> <br>`;
